...
export default function ContactForm({ lang = 'en' }) {
  ...
  return (
    <section className="relative py-14 px-0 w-full min-w-0 bg-gradient-to-br from-gold-50 via-white to-gold-100 dark:from-black dark:via-gray-900 dark:to-gold-950 min-h-[30vh] overflow-hidden">
      ...
      <div className="relative z-10 w-full min-w-0 px-0 mx-0 md:mx-auto md:max-w-xl">
